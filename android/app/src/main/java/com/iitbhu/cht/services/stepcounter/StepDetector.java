...
public class StepDetector {
    ...
    * Class constructor.
     ...
     * utilized. The vector length (= speed at a certain point in time) is also calculated for each data record and
    ...
    public class AccelerationDataSorter implements Comparator<AccelerationData> {
        /**
         * The compare method compares two data records from AccelerationData on the basis of the
